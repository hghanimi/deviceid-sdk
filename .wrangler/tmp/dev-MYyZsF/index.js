...
var DeviceID = class {
  ...
  getBrowserInfo() {
    return {
      userAgent: "Cloudflare-Workers".substring(0, 100),
  ...
  getStoredIds() {
    try {
      return {
        localStorage: localStorage.getItem("deviceid_visitor_id") || void 0,
        sessionStorage: sessionStorage.getItem("deviceid_visitor_id") || void 0
      };
    } catch {
      return {};
    }
